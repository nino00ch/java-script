...
console.log(fullName2("Ines", "Chabla"));
console.log(fullName2("Afaf", "kelai"));
console.log(fullName2("Nada", "ouledmouloud"));
//  Declare a function addNumbers and it takes two parameters and it returns
// sum.000 =}}
const addNumbers = (a, b) => a + b

//  An area of a rectangle is calculated as follows: area = length x width. Write a
...
// define different weight groups in adults 20 years old or older.Check if a person
// is underweight, normal, overweight or obese based the information given
// below.
...
console.log(solveLinEquation(1, 2, 1));

//  Quadratic equation is calculated as follows: ax2  bx + c  0. Write a
// function which calculates value or values of a quadratic
...
//  2
//  Exo
// Declare a function name printArray. It takes array as a parameter and it
...
//  Declare a function name reverseArray. It takes array as a parameter and it
...
//  Declare a function name addItem. It takes an item parameter and it returns
// an array after adding the item
//  Declare a function name removeItem. It takes an index parameter and it
...
//  Declare a function name sumOfEven. It takes a number parameter and it
...
//  3
//  Exo
// Write a function which takes any number of arguments and return the sum
// of the arguments
//  sum(1, 2, 3) // -> 6
//  sum(1, 2, 3, 4) // -> 10
//  Write a function which generates a randomUserIp.
//  Write a function which generates a randomMacAddress
//  Declare a function name randomHexaNumberGenerator. When this
// function is called it generates a random hexadecimal number. The function
...
//  41XTDbE
//  Exercises: Level 3
//  Modify question number n . Declare a function
// name userIdGeneratedByUser. It doesnʼt take any parameter but it takes
...
// colors in an array.
//  Write a function convertHexaToRgb which converts hexa color to rgb and
// it returns an rgb color.
//  Write a function convertRgbToHexa which converts rgb to hexa color and
// it returns an hexa color.
//  Write a function generateColors which can generate any number of hexa
// or rgb colors.
//  console.log(generateColors('hexa', 3)) // ['#a3e12f', '#03ed55', '#eb3d2b']
//  console.log(generateColors('hexa', 1)) // '#b334ef'
//  console.log(generateColors('rgb', 3)) // ['rgb(5, 55, 175)', 'rgb(50, 105, 100)',
// 'rgb(15, 26, 80)']
...
// except $ or _. Write a function isValidVariable which check if a variable is
// valid or invalid variable.
